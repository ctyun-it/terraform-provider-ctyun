...
func NewRocketmqService(meta *common.CtyunMetadata) *RocketmqService {
	return &RocketmqService{meta: meta}
}

func (c RocketmqService) CheckVhostExist(ctx context.Context, vhost, instanceID, regionID string) (exist bool, err error) {
...
func (c RocketmqService) CheckExchangeExist(ctx context.Context, name, vhost, instanceID, regionID string) (exist bool, err error) {
...
func (c RocketmqService) CheckTopicExist(ctx context.Context, name, vhost, instanceID, regionID string) (exist bool, err error) {
