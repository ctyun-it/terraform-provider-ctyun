...
func UseStateForNull() planmodifier.String {
...
func (m useStateForNull) PlanModifyString(ctx context.Context, req planmodifier.StringRequest, resp *planmodifier.StringResponse) {
