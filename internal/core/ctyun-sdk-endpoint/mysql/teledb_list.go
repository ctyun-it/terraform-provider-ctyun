...
type TeledbGetListResponseReturnReadNodeDetail struct {
	...
	TeledbVersion               string `json:"teledbVersion"`
	...
	Vip                         string `json:"vip"`
	InstanceNormal              bool   `json:"instanceNormal"`
	OrderSrc                    int32  `json:"orderSrc"`
	...
	AgMysqlVersion              string `json:"agMysqlVersion"`
	ProjectName                 string `json:"projectName"`
	ExceptionCode               int32  `json:"exceptionCode"`
	ProjectId                   string `json:"projectId"`
	BackupInstance              bool   `json:"backupInstance"`
	ProdInstFlag                string `json:"prodInstFlag"`
	Alive                       int32  `json:"alive"`
	ProdDbEngine                string `json:"prodDbEngine"`
	RefundStatus                bool   `json:"refundStatus"`
	TeledbVersionProduct        string `json:"teledbVersionProduct"`
	...
	CanSetInstReadOnly          bool   `json:"canSetInstReadOnly"`
	MachineSpec                 string `json:"machineSpec"`
	ProdInstName                string `json:"prodInstName"`
	Resources                   string `json:"resources"`
	UserId                      int64  `json:"userId"`
	ProdBillTime                int64  `json:"prodBillTime"`
	RenewalEnable               bool   `json:"renewalEnable"`
	IsMGR                       int32  `json:"isMGR"`
	TeledbVersionCore           string `json:"teledbVersionCore"`
	CreateTime                  int64  `json:"createTime"`
	TenantId                    string `json:"tenantId"`
	DeleteEnable                bool   `json:"deleteEnable"`
	CanReadOnlyToSingle         bool   `json:"canReadOnlyToSingle"`
...
type TeledbGetListResponseReturnDetailList struct {
	...
	RenewalEnable               bool                                        `json:"renewalEnable"`
	IsMGR                       int32                                       `json:"isMGR"`
	ReadNode                    []TeledbGetListResponseReturnReadNodeDetail `json:"readNode"`
}
