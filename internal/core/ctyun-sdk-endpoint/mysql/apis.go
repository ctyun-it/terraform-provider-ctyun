...
type Apis struct {
	...
	TeledbGetParameterTemplateGroupDetailApi *TeledbGetParameterTemplateGroupDetailApi
}
...
func NewApis(client *ctyunsdk.CtyunClient) *Apis {
	...
	return &Apis{
		...
		TeledbGetParameterTemplateGroupDetailApi: NewTeledbGetParameterTemplateGroupDetailApi(client),
	}
}
