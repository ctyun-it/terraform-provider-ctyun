...
// CcseCreateNamespaceV2P2Api
/* 创建指定集群下的namespace
 */type CcseCreateNamespaceV2P2Api struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCcseCreateNamespaceV2P2Api(client *core.CtyunClient) *CcseCreateNamespaceV2P2Api {
	return &CcseCreateNamespaceV2P2Api{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CcseCreateNamespaceV2P2Api) Do(ctx context.Context, credential core.Credential, req *CcseCreateNamespaceV2P2Request) (*CcseCreateNamespaceV2P2Response, error) {
	...
	var resp CcseCreateNamespaceV2P2Response
...
type CcseCreateNamespaceV2P2Request struct {
...
type CcseCreateNamespaceV2P2Response struct {
