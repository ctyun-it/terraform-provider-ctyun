...
// CcseGetNamespaceV2P2Api
/* 查询指定集群下的namespace详情
 */type CcseGetNamespaceV2P2Api struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCcseGetNamespaceV2P2Api(client *core.CtyunClient) *CcseGetNamespaceV2P2Api {
	return &CcseGetNamespaceV2P2Api{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CcseGetNamespaceV2P2Api) Do(ctx context.Context, credential core.Credential, req *CcseGetNamespaceV2P2Request) (*CcseGetNamespaceV2P2Response, error) {
	...
	var resp CcseGetNamespaceV2P2Response
...
type CcseGetNamespaceV2P2Request struct {
...
type CcseGetNamespaceV2P2Response struct {
