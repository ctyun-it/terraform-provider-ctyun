...
// CcseUpdateNamespaceV2P2Api
/* 更新指定集群下的namespace
 */type CcseUpdateNamespaceV2P2Api struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCcseUpdateNamespaceV2P2Api(client *core.CtyunClient) *CcseUpdateNamespaceV2P2Api {
	return &CcseUpdateNamespaceV2P2Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodPut,
			UrlPath:      "/v2/cce/clusters/{clusterName}/api/v1/namespaces/{namespaceName}",
			ContentType:  "text/plain",
		},
	}
}

func (a *CcseUpdateNamespaceV2P2Api) Do(ctx context.Context, credential core.Credential, req *CcseUpdateNamespaceV2P2Request) (*CcseUpdateNamespaceV2P2Response, error) {
	...
	var resp CcseUpdateNamespaceV2P2Response
...
type CcseUpdateNamespaceV2P2Request struct {
	...
	TextPlainDataString string `json:"textPlainDataString,omitempty"` /*  字符串类型的yaml资源或json资源  */
}

type CcseUpdateNamespaceV2P2Response struct {
