...
// CcseDeleteNamespaceV2P2Api
/* 删除指定集群下的namespace
 */type CcseDeleteNamespaceV2P2Api struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCcseDeleteNamespaceV2P2Api(client *core.CtyunClient) *CcseDeleteNamespaceV2P2Api {
	return &CcseDeleteNamespaceV2P2Api{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CcseDeleteNamespaceV2P2Api) Do(ctx context.Context, credential core.Credential, req *CcseDeleteNamespaceV2P2Request) (*CcseDeleteNamespaceV2P2Response, error) {
	...
	var resp CcseDeleteNamespaceV2P2Response
...
type CcseDeleteNamespaceV2P2Request struct {
...
type CcseDeleteNamespaceV2P2Response struct {
