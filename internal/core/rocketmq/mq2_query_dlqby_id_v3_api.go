...
// Mq2QueryDlqbyIdV3Api
/* 通过传入MessageID查询指定的死信消息 */
type Mq2QueryDlqbyIdV3Api struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewMq2QueryDlqbyIdV3Api(client *core.CtyunClient) *Mq2QueryDlqbyIdV3Api {
	return &Mq2QueryDlqbyIdV3Api{
		client: client,
		template: core.CtyunRequestTemplate{
			EndpointName: EndpointName,
			Method:       http.MethodGet,
			UrlPath:      "/v3/dlq/getById",
			ContentType:  "application/x-www-form-urlencoded",
		},
	}
}

func (a *Mq2QueryDlqbyIdV3Api) Do(ctx context.Context, credential core.Credential, req *Mq2QueryDlqbyIdV3Request) (*Mq2QueryDlqbyIdV3Response, error) {
	...
	var resp Mq2QueryDlqbyIdV3Response
...
type Mq2QueryDlqbyIdV3Request struct {
...
type Mq2QueryDlqbyIdV3Response struct {
	StatusCode *string                             `json:"statusCode"` /*  接口系统层面状态码。成功：800，失败：900  */
	Message    *string                             `json:"message"`    /*  描述状态  */
	ReturnObj  *Mq2QueryDlqbyIdV3ReturnObjResponse `json:"returnObj"`  /*  返回对象  */
	Error      *string                             `json:"error"`      /*  错误码，只有非成功才有这个字段，方便快速定位问题  */
}

type Mq2QueryDlqbyIdV3ReturnObjResponse struct {
	Data *Mq2QueryDlqbyIdV3ReturnObjDataResponse `json:"data"` /*  返回具体数据  */
}

type Mq2QueryDlqbyIdV3ReturnObjDataResponse struct {
	...
	Properties                *Mq2QueryDlqbyIdV3ReturnObjDataPropertiesResponse `json:"properties"`                /*  消息属性  */
	MessageBody               *string                                           `json:"messageBody"`               /*  消息体内容  */
}

type Mq2QueryDlqbyIdV3ReturnObjDataPropertiesResponse struct {
