...
type CtgkafkaTopicQueryV3ReturnObjResponse struct {
	...
	MaxPartitions      int32                                        `json:"maxPartitions"`      /*  分区数量上限。  */
	RemainPartitions   int32                                        `json:"remainPartitions"`   /*  剩余分区数量。  */
	TopicMaxPartitions int32                                        `json:"topicMaxPartitions"` /*  主题最大分区数量。  */
	Data               []*CtgkafkaTopicQueryV3ReturnObjDataResponse `json:"data"`               /*  主题信息。  */
}

type CtgkafkaTopicQueryV3ReturnObjDataResponse struct {
	ProdInstId   string                                            `json:"prodInstId"`   /*  集群ID。  */
