...
type CtecsDetailsInstanceV41Response struct {
	...
	ReturnObj   *CtecsDetailsInstanceV41ReturnObjResponse `json:"returnObj,omitempty"`   /*  成功时返回的数据  */
}
...
type CtecsDetailsInstanceV41ReturnObjResponse struct {
	...
	AttachedVolume      []*string                                                  `json:"attachedVolume,omitempty"`      /*  云硬盘ID列表  */
	Addresses           []*CtecsDetailsInstanceV41ReturnObjAddressesResponse       `json:"addresses,omitempty"`           /*  网络地址信息  */
	...
	OsType              int32                                                      `json:"osType"`                        /*  操作系统类型，详见枚举值表  */
	InstanceStatus      *string                                                    `json:"instanceStatus,omitempty"`      /*  云主机状态，取值范围：<br />backingup: 备份中，<br />creating: 创建中，<br />expired: 已到期，<br />freezing: 已冻结，<br />rebuild: 重装，<br />restarting: 重启中，<br />running: 运行中，<br />starting: 开机中，<br />stopped: 已关机，<br />stopping: 关机中，<br />error: 错误，<br />snapshotting: 快照创建中，<br />unsubscribed: 包周期已退订。  */
	ExpiredTime         *string                                                    `json:"expiredTime,omitempty"`         /*  到期时间  */
	AvailableDay        int32                                                      `json:"availableDay"`                  /*  可用天数  */
	...
	SecGroupList        []*CtecsDetailsInstanceV41ReturnObjSecGroupListResponse    `json:"secGroupList,omitempty"`        /*  安全组信息  */
	PrivateIP           *string                                                    `json:"privateIP,omitempty"`           /*  内网IPv4地址  */
	PrivateIPv6         *string                                                    `json:"privateIPv6,omitempty"`         /*  内网IPv6地址  */
	NetworkCardList     []*CtecsDetailsInstanceV41ReturnObjNetworkCardListResponse `json:"networkCardList,omitempty"`     /*  网卡信息  */
	VipInfoList         []*CtecsDetailsInstanceV41ReturnObjVipInfoListResponse     `json:"vipInfoList,omitempty"`         /*  虚拟IP信息列表  */
	VipCount            int32                                                      `json:"vipCount"`                      /*  vip数目  */
	AffinityGroup       *CtecsDetailsInstanceV41ReturnObjAffinityGroupResponse     `json:"affinityGroup,omitempty"`       /*  云主机组信息  */
	Image               *CtecsDetailsInstanceV41ReturnObjImageResponse             `json:"image,omitempty"`               /*  镜像信息  */
	Flavor              *CtecsDetailsInstanceV41ReturnObjFlavorResponse            `json:"flavor,omitempty"`              /*  云主机规格信息  */
	OnDemand            *bool                                                      `json:"onDemand,omitempty"`            /*  付费方式，取值范围：<br />true：表示按量付费 <br />false：表示包周期  */
	VpcName             *string                                                    `json:"vpcName,omitempty"`             /*  虚拟私有云名称  */
	VpcID               *string                                                    `json:"vpcID,omitempty"`               /*  虚拟私有云ID  */
	FixedIPList         []*string                                                  `json:"fixedIPList,omitempty"`         /*  内网IP列表  */
	FloatingIP          *string                                                    `json:"floatingIP,omitempty"`          /*  公网IP  */
	SubnetIDList        []*string                                                  `json:"subnetIDList,omitempty"`        /*  子网ID列表  */
	KeypairName         *string                                                    `json:"keypairName,omitempty"`         /*  密钥对名称  */
	DeletionProtection  *bool                                                      `json:"deletionProtection,omitempty"`  /*  是否开启实例删除保护  */
	DelegateName        *string                                                    `json:"delegateName,omitempty"`        /*  委托名称，注：委托绑定目前仅支持多可用区类型资源池，非可用区资源池为空字符串  */
	RemainingDay        int32                                                      `json:"remainingDay"`                  /*  距离释放剩余天数  */
	ReleaseTime         *string                                                    `json:"releaseTime,omitempty"`         /*  释放时间  */
	Metadata            map[string]interface{}                                     `json:"metadata,omitempty"`            /*  用户自定义元数据，注：仅多可用区类型资源池支持返回，非可用区资源池请调用查询元数据接口 <br />获取：<br /><span style="background-color: rgb(73, 204, 144);color: rgb(255,255,255);padding: 2px; margin:2px">查</span> <a  href="https://eop.ctyun.cn/ebp/ctapiDocument/search?sid=25&api=8319&data=87&isNormal=1">云主机元数据查询</a>   */
	InstanceDescription *string                                                    `json:"instanceDescription,omitempty"` /*  云主机描述信息  */
	LabelList           []*CtecsDetailsInstanceV41ReturnObjLabelListResponse       `json:"labelList,omitempty"`           /*  标签列表  */
	PciInfo             *CtecsDetailsInstanceV41ReturnObjPciInfoResponse           `json:"pciInfo,omitempty"`             /*  pci地址信息，注：仅多可用区类型资源池返回；该字段内测中  */
}

type CtecsDetailsInstanceV41ReturnObjAddressesResponse struct {
	VpcName     *string                                                         `json:"vpcName,omitempty"`     /*  vpc名称  */
	AddressList []*CtecsDetailsInstanceV41ReturnObjAddressesAddressListResponse `json:"addressList,omitempty"` /*  网络地址列表  */
}
...
type CtecsDetailsInstanceV41ReturnObjFlavorResponse struct {
	...
	FlavorCPU    int32   `json:"flavorCPU"`            /*  VCPU  */
	FlavorRAM    int32   `json:"flavorRAM"`            /*  内存  */
	GpuType      *string `json:"gpuType,omitempty"`    /*  GPU类型，取值范围：T4、V100、V100S、A10、A100、atlas 300i pro、mlu370-s4，支持类型会随着功能升级增加  */
	GpuCount     int32   `json:"gpuCount"`             /*  GPU数目  */
	GpuVendor    *string `json:"gpuVendor,omitempty"`  /*  GPU名称  */
	VideoMemSize int32   `json:"videoMemSize"`         /*  GPU显存大小  */
}

type CtecsDetailsInstanceV41ReturnObjLabelListResponse struct {
	LabelKey   *string `json:"labelKey,omitempty"`   /*  标签键  */
	LabelValue *string `json:"labelValue,omitempty"` /*  标签值  */
}

type CtecsDetailsInstanceV41ReturnObjPciInfoResponse struct {
	NicPciList []*CtecsDetailsInstanceV41ReturnObjPciInfoNicPciListResponse `json:"nicPciList,omitempty"` /*  网卡pci信息列表  */
}

type CtecsDetailsInstanceV41ReturnObjAddressesAddressListResponse struct {
	Addr       *string `json:"addr,omitempty"`       /*  IP地址  */
	Version    int32   `json:"version"`              /*  IP版本  */
	RawType    *string `json:"type,omitempty"`       /*  网络类型，取值范围：<br />fixed：内网，<br />floating：弹性公网  */
	IsMaster   *bool   `json:"isMaster,omitempty"`   /*  网络地址对应网卡是否为主网卡  */
	MacAddress *string `json:"macAddress,omitempty"` /*  网络地址对应网卡的mac地址  */
}

type CtecsDetailsInstanceV41ReturnObjPciInfoNicPciListResponse struct {
	NetworkInterfaceID *string `json:"networkInterfaceID,omitempty"` /*  网卡id  */
	Pci                *string `json:"pci,omitempty"`                /*  pci地址  */
}
