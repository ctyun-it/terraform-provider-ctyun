...
type CtvpcNewIPv6BandwidthListReturnObjResponse struct {
	...
	Objs         []*CtvpcNewIPv6BandwidthListReturnObj `json:"ipv6BandwidthList"`
}

type CtvpcNewIPv6BandwidthListReturnObj struct {
	...
	Ipv6GatewayID *string `json:"ipv6GatewayID,omitempty"`
}
