...
func TestValidateEndpointHandler(t *testing.T) {
	...
	svc.Handlers.Clear()
	svc.Handlers.Validate.PushBackNamed(ValidateEndpointHandler)
...
func TestSendHandlerError(t *testing.T) {
	...
	svc.Handlers.Clear()
	svc.Handlers.Send.PushBackNamed(SendHandler)
...
func TestValidateReqSigHandler(t *testing.T) {
	...
	for i, c := range cases {
		...
		ValidateReqSigHandler.Fn(c.Req)
