...
func TestPaginationQueryPage(t *testing.T) {
	...
	db.Handlers.Build.PushBack(func(r *Request) {
	...
	db.Handlers.Unmarshal.PushBack(func(r *Request) {
		r.Data = resps[reqNum]
		reqNum++
	})
...
func TestSkipPagination(t *testing.T) {
	...
	client.Handlers.Unmarshal.PushBack(func(r *Request) {
...
func TestPaginationNilToken(t *testing.T) {
	...
	idents := []string{}
	client.Handlers.Build.PushBack(func(r *Request) {
	...
	for _, testcase := range cases {
		...
		p := Pagination{
			...
			NewRequest: func() (*Request, error) {
				...
				r.Handlers.Clear()
				r.Handlers.Build.PushBack(func(req *Request) {
				...
				r.Handlers.Unmarshal.PushBack(func(req *Request) {
					out := &testPageOutput{
						Value: c[i].Value,
					}
