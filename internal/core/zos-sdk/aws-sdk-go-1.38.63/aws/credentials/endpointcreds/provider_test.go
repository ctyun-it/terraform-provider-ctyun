...
func TestRetrieveRefreshableCredentials(t *testing.T) {
	...
	client := NewProviderClient(*unit.Session.Config,
	...
	client.(*Provider).CurrentTime = func() time.Time {
...
func TestRetrieveStaticCredentials(t *testing.T) {
	...
	client := NewProviderClient(*unit.Session.Config, unit.Session.Handlers, server.URL)
	creds, err := client.Retrieve()
