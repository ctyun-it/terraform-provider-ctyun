...
type UploadInput struct {
	...
	// Append Object, if set(true or false), upload object in append mode
	Append *bool `location:"querystring" locationName:"append" type:"boolean"`

	// Position to allow appending
	AppendPosition *int64 `location:"querystring" locationName:"position" type:"integer"`
