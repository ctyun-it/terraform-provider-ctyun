...
type S3API interface {
	...
	GetObjectsPackage(*s3.GetObjectsPackageInput) (*s3.GetObjectsPackageOutput, error)
	GetObjectsPackageWithContext(aws.Context, *s3.GetObjectsPackageInput, ...request.Option) (*s3.GetObjectsPackageOutput, error)
	GetObjectsPackageRequest(*s3.GetObjectsPackageInput) (*request.Request, *s3.GetObjectsPackageOutput)
	...
	GetUsageStats(*s3.GetUsageStatsInput) (*s3.GetUsageStatsOutput, error)
	GetUsageStatsWithContext(aws.Context, *s3.GetUsageStatsInput, ...request.Option) (*s3.GetUsageStatsOutput, error)
	GetUsageStatsRequest(*s3.GetUsageStatsInput) (*request.Request, *s3.GetUsageStatsOutput)
	...
	MdSearch(*s3.MdSearchInput) (*s3.MdSearchOutput, error)
	MdSearchWithContext(aws.Context, *s3.MdSearchInput, ...request.Option) (*s3.MdSearchOutput, error)
	MdSearchRequest(*s3.MdSearchInput) (*request.Request, *s3.MdSearchOutput)

	PostObjectsPackage(*s3.PostObjectsPackageInput) (*s3.PostObjectsPackageOutput, error)
	PostObjectsPackageWithContext(aws.Context, *s3.PostObjectsPackageInput, ...request.Option) (*s3.PostObjectsPackageOutput, error)
	PostObjectsPackageRequest(*s3.PostObjectsPackageInput) (*request.Request, *s3.PostObjectsPackageOutput)

	ProcessObject(*s3.ProcessObjectInput) (*s3.ProcessObjectOutput, error)
	ProcessObjectWithContext(aws.Context, *s3.ProcessObjectInput, ...request.Option) (*s3.ProcessObjectOutput, error)
	ProcessObjectRequest(*s3.ProcessObjectInput) (*request.Request, *s3.ProcessObjectOutput)
