 ...
 */type CtimageUnshareImageApi struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCtimageUnshareImageApi(client *core.CtyunClient) *CtimageUnshareImageApi {
	return &CtimageUnshareImageApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtimageUnshareImageApi) Do(ctx context.Context, credential core.Credential, req *CtimageUnshareImageRequest) (*CtimageUnshareImageResponse, error) {
	builder := core.NewCtyunRequestBuilder(a.template)
	builder.WithCredential(credential)
	ctReq := builder.Build()
	_, err := ctReq.WriteJson(struct {
		*CtimageUnshareImageRequest
	}{
		req,
	...
	var resp CtimageUnshareImageResponse
...
type CtimageUnshareImageRequest struct {
...
type CtimageUnshareImageResponse struct {
	...
	Description string                                `json:"description,omitempty"` /*  英文描述信息  */
	ReturnObj   *CtimageUnshareImageReturnObjResponse `json:"returnObj"`             /*  成功时返回的数据  */
}

type CtimageUnshareImageReturnObjResponse struct{}
