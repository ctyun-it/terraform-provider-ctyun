 ...
 */type CtimageDeleteImageApi struct {
	template core.CtyunRequestTemplate
	client   *core.CtyunClient
}

func NewCtimageDeleteImageApi(client *core.CtyunClient) *CtimageDeleteImageApi {
	return &CtimageDeleteImageApi{
		client: client,
		template: core.CtyunRequestTemplate{
...
func (a *CtimageDeleteImageApi) Do(ctx context.Context, credential core.Credential, req *CtimageDeleteImageRequest) (*CtimageDeleteImageResponse, error) {
	builder := core.NewCtyunRequestBuilder(a.template)
	builder.WithCredential(credential)
	ctReq := builder.Build()
	_, err := ctReq.WriteJson(struct {
		*CtimageDeleteImageRequest
	}{
		req,
	...
	var resp CtimageDeleteImageResponse
...
type CtimageDeleteImageRequest struct {
...
type CtimageDeleteImageResponse struct {
	...
	ReturnObj   *CtimageDeleteImageReturnObjResponse `json:"returnObj"`             /*  成功时返回的数据  */
}

type CtimageDeleteImageReturnObjResponse struct{}
